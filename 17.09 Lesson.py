...
#
#while a<=i<=b: #пока переменная і находится в диапазоне от а до b, мы будем складывать числа в инетрвале. Как только выйдем за интервал - перестаем складывать числа.
...
#i = a
#
#while a<=i<=b: #пока переменная і находится в диапазоне от а до b, мы будем складывать числа в инетрвале. Как только станет больше - прекращаем складывать числа.
#    if i % 2 == 0:
#        s+=i # складываем слагаемые в интервале
#        i+=2 # i увеличивается на 2
#    else:
#        i=a+1
#        s += i  # складываем слагаемые в интервале
#        i += 2  # i увеличивается на 2
